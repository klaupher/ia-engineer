export class View {
  ...
  initializeParameters() {
    this.elements.topK.max = 3; //params.maxTopK;
    this.elements.topK.min = 1;
    this.elements.topK.value = 3; //params.defaultTopK;
    this.elements.topKValue.textContent = 3; //params.defaultTopK;

    this.elements.temperatureValue.textContent = 4; //params.defaultTemperature;
    this.elements.temperature.max = 4; //params.maxTemperature;
    this.elements.temperature.min = 0;
    this.elements.temperature.value = 4; //params.defaultTemperature;
  }

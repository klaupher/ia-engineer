...
import { createAvailableNode } from "./nodes/availableNode.ts";
...
const AppointmentStateAnnotation = z.object({
    ...
    intent: z.enum(['schedule', 'cancel', 'available', 'unknown']).optional(),
...
export function buildAppointmentGraph(llmClient: OpenRouterService, appointmentService: AppointmentService) {
    ...
    const workflow = new StateGraph({
        ...
        .addNode('available', createAvailableNode(appointmentService))

...
(async function main() {
    ...
    */
    ...
    elements.topK.max = 3; //params.maxTopK;
    elements.topK.min = 1;
    elements.topK.value = 3; //params.defaultTopK;
    elements.topKValue.textContent = 3; //params.defaultTopK;

    elements.temperatureValue.textContent = 1; //params.defaultTemperature;
    elements.temperature.max = 2; //params.maxTemperature;
    elements.temperature.min = 0;
    elements.temperature.value = 1; //params.defaultTemperature;
